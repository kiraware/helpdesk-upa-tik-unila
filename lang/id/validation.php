...
return [
    ...
    */
    ...
    'encoding' => 'Kolom :attribute harus dienkripsi menggunakan :encoding.',
    ...
    'gte' => [
        ...
        'file' => 'Kolom :attribute harus berukuran lebih besar dari atau sama dengan :value kilobyte.',
    ...
    'max' => [
        ...
        'file' => 'Kolom :attribute tidak boleh berukuran lebih besar dari :max kilobyte.',
        'numeric' => 'Kolom :attribute tidak boleh bernilai lebih besar dari :max.',
        'string' => 'Kolom :attribute tidak boleh berisi lebih besar dari :max karakter.',
    ],
