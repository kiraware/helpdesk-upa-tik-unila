        ...
        <div class="grid grid-cols-1 sm:grid-cols-12 gap-4">
            ...
            <div class="sm:col-span-4 lg:col-span-3 relative" x-data="{ open: false }">
                ...
                <button type="button" @click="open = !open"
                    class="h-10 w-full flex items-center justify-between px-4 py-2
                        border border-border-light dark:border-border-dark
                        rounded-lg
                        bg-surface-light dark:bg-slate-800
                    ...
                    <span class="flex items-center gap-2">
                        <span class="material-icons-round text-base text-muted-light">
                            filter_alt
                        </span>
                ...
                <div x-show="open" x-transition x-cloak @click.outside="open = false"
                    ...
                    <button type="submit" name="status" value="1"
                        class="w-full text-left px-4 py-2.5 text-sm
                            hover:bg-gray-100/70 dark:hover:bg-slate-700/60
                            {{ request('status') === '1' ? 'font-semibold text-emerald-600 dark:text-emerald-400' : '' }}">
                        Aktif
                    </button>
                    ...
                    <button type="submit" name="status" value="0"
                        class="w-full text-left px-4 py-2.5 text-sm
                            hover:bg-gray-100/70 dark:hover:bg-slate-700/60
                            {{ request('status') === '0' ? 'font-semibold text-red-600 dark:text-red-400' : '' }}">
                        Non Aktif
                    </button>
                </div>
            </div>
