<x-layouts.dashboard title="Tiket Menunggu">

    <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
        <div>
            <h1 class="text-2xl font-bold text-text-light dark:text-text-dark">Tiket Menunggu</h1>
            <p class="text-sm text-muted-light dark:text-muted-dark">Tiket yang belum diambil petugas</p>
        </div>
    </div>
