            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Syarat Lampiran
                        (Opsional)</label>
                    <textarea name="attachment_requirement" rows="3"
                        placeholder="Contoh: Lampirkan surat permohonan yang ditandatangani pimpinan..."
                        class="block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-secondary focus:ring-secondary sm:text-sm py-2.5 px-3">{{ old('attachment_requirement') }}</textarea>
