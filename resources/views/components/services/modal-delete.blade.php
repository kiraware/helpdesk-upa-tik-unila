<div id="deleteServiceModal"
    ...
    <div class="bg-surface-light dark:bg-surface-dark rounded-xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        <div
            ...
            <h3 class="text-lg font-bold text-gray-800 dark:text-white">Hapus Layanan</h3>
        </div>
        <div class="p-6">
            <p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                Apakah Anda yakin ingin menghapus layanan <span class="font-semibold text-gray-900 dark:text-white"
                    id="deleteServiceName"></span>? <br><br>
