                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <textarea name="notes" placeholder="Contoh: Lampirkan surat permohonan yang ditandatangani pimpinan..."
                            class="flex-1 block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-secondary focus:ring-secondary sm:text-sm py-2.5 px-3 resize-none">{{ $service->notes }}</textarea>
