<div id="addDivisionModal"
    ...
    <div class="bg-surface-light dark:bg-surface-dark rounded-xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        <div
            ...
            <h3 class="text-lg font-bold text-gray-800 dark:text-white">Tambah Divisi Baru</h3>
        ...
        <form action="{{ route('divisions.store') }}" method="POST">
            ...
            <div class="p-6 space-y-6">
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Nama Divisi</label>
                    <div class="relative">
                        <span
