<div id="deleteDivisionModal"
    ...
    <div class="bg-surface-light dark:bg-surface-dark rounded-xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        <div
            ...
            <h3 class="text-lg font-bold text-gray-800 dark:text-white">Hapus Penanggung Jawab</h3>
        </div>
        <div class="p-6">
            <p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                Apakah Anda yakin ingin menghapus penanggung jawab <span
                    class="font-semibold text-gray-900 dark:text-white" id="deleteDivisionName"></span>? <br><br>
        ...
        <div
            ...
            <form id="deleteDivisionForm" method="POST">
                ...
                @method('DELETE')
                <button type="submit"
                    class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-medium shadow-sm">Hapus</button>
            </form>
        </div>
    </div>
</div>
