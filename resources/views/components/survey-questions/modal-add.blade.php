<div id="addQuestionModal"
    ...
    <div
        ...
        <div
            ...
            <h3 class="text-lg font-bold text-gray-800 dark:text-white">Tambah Pertanyaan Kuesioner Baru</h3>
        ...
        <form action="{{ route('survey-questions.store') }}" method="POST" class="flex flex-col overflow-hidden">
            @csrf
            <div class="p-6 space-y-6 overflow-y-auto custom-scrollbar">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="aspect_name" value="{{ old('aspect_name') }}"
                            placeholder="Contoh: Kecepatan Layanan" required maxlength="100"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="satisfaction_question" placeholder="Contoh: Seberapa puas Anda dengan kecepatan layanan kami?" required
                            maxlength="500" rows="3"
                            class="pl-10 block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-secondary focus:ring-secondary sm:text-sm py-2.5 resize-none">{{ old('satisfaction_question') }}</textarea>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="importance_question" placeholder="Contoh: Seberapa penting kecepatan layanan ini bagi Anda?" required
                            maxlength="500" rows="3"
                            class="pl-10 block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-secondary focus:ring-secondary sm:text-sm py-2.5 resize-none">{{ old('importance_question') }}</textarea>
                    </div>
                </div>
